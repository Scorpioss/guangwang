...
<template>
  <div class="agreement">
    ...
    <div class="T_content">
      ...
      (hereinafter referred to as “Agreement”)before registering. In order to
      clarify rights and obligations of all parties,and protect the legitimate
      rights and interests of all parties,this Agreement is specially
      formulated.the contents highlighted in bold underline in this Agreement
      are specially reminded of your attention.Please ensure that you fully
      understand this Agreement.You are not authorized to register ,log in or
      use our services or software(hereinafter referred to as services,
      software)unless you accept all the Agreement.Your
      registration,login,usage,etc.will bu deemed as acceptance of this
      Agreement and you agree to be bound by the Agreement. We reserve the
      right,at our discretion, to change,modify,add,or remove portions of the
      Agreement,sup;ementary Agreement,Privacy Policy,regulative provisions or
      feature terms at any time by posting the amended version on our software
      or within the services without prior noice.If you do not agree to these
      terms or any future amended version,then you must not access,use our
      services.Otherwise,your access,use of our services shall be deemed to
      agree any future updated version of them.
    </div>
    ...
    <div class="T_title">6.Membership</div>
    <div class="T_content">
    ...
    <div class="T_title">7. Subscriptions and Virtual Currency</div>
    <div class="T_content">
      7.1 Subscriptions You can buy different subscription packages according to
      one month, two months and three months. For all mobile subscriptions, the
      fee will be deducted from your iTunes or Google account when you confirm
      your purchase. Your subscription will be automatically renewed unless you
      turn off the automatic renewal feature at least 24 hours before the end of
      your current subscription. This is because your account may be charged for
      renewal within 24 hours before the end of the current subscription period.
      You can manage your subscriptions and turn off automatic renewal by
      accessing your iTunes or Google account settings. You cannot cancel the
      current subscription during the subscription period, but you can cancel
      automatic renewal at any time.
      <br /><br />
      Purchases of subscriptions are non refundable and non transferable, even
      if they expire or stop. We may change the purchase price of the
      subscription and the features included in the subscription at any time. We
      reserve the right to stop publishing and subscribing and set the
      subscription expiration date at any time. Subscriptions cannot be
      exchanged for any amount or currency value.
      <br /><br />
      7.2 Virtual Currency When you purchase or receive Virtual Currency
      products such as Diamonds you do not own them. Diamonds are used to upload
      stories, use filters and use video chat features, etc. You agree that we
      will have no liability to you based on the exercise of our rights with
      respect to coins and other Virtual Currencies. We reserve the right to
      verify your identity and eligibility to use your Virtual Currencies.
      <br /><br />
      We are not responsible for repairing or replacing Virtual Currencies, or
      providing you with any credit or refund in the event that we modify,
      suspend, or terminate the Virtual Currencies, or the Story, or for loss or
      damage due to any service error, or any other reason. Purchases of Virtual
      Currency may not be sub-licensed and are non-refundable and
      non-transferable, even if they expire or are revoked or discontinued. We
      may change the purchase price for Virtual Currency at any time, as well as
      the ways you can use Virtual Currency. We reserve the right to revoke or
      stop issuing Virtual Currency at any time without notice, refund, or
      compensation, and to set expiration dates for Virtual Currency. Virtual
      Currency may not be redeemed for any sum of money or monetary value. If
      you delete your account or your account is terminated for any reason, you
      will lose all accumulated and unused Virtual Currency without refund or
      other compensation. You agree that we will have no liability to you based
      on the exercise of our rights with respect to Virtual Currency. Virtual
      Currency purchased or received by any user does not constitute property
      and is not transferable.
      <br /><br />
      7.3 Payment Method Our paid services Our paid services can be purchased
      through your account with some third parties, such as your Apple iTunes
      account or your Google play account ("third party account"). If you
      purchase any paid services through a third-party account, the bill for
      these paid services will be displayed through your third-party account.
      You should review the terms of service for third-party accounts that we
      have no control over.
      <br /><br />
      7.4 Unsubscribe If you purchase a subscription through a third-party
      account, you will need to cancel your subscription through that
      third-party and in accordance with that third party’s terms of Service. If
      you cancel your subscription, your subscription benefits will continue
      until the end of your then-current subscription term, but your
      subscription will not be renewed after that term expires. You will not be
      entitled to a prorated refund of any portion of the subscription fees paid
      for the then-current subscription term.
      <br /><br />
      7.5 Term/Fees This Agreement shall remain in full force and effect while
      you use the mobile application and website and/or the Service. We may
      terminate your membership for any reason, at any time, without notice. If
      we terminate your Membership in the Service, you shall not be entitled to
      a refund of any unused portion of subscription fees, if any. Even after
      membership is terminated, this Agreement will remain in effect. Our
      Services' Terms of Service and/or subscription fees, if any, that were
      provided to you at registration is subject to change if needed. By using
      the Service and becoming a Member, you acknowledge that we reserve the
      right to charge for the Service and have the right to terminate a Member's
      Membership, should a Member breach this Agreement or fail to pay for the
      Service if necessary, as required by this Agreement. Standard usage
      charges for SMS, MMS, and other data charges may apply and may be billed
      on your wireless service bill or deducted from your prepaid balance.
      <br /><br />
    </div>
    <div class="T_title">8. Data Storage</div>
    <div class="T_content">
    ...
    <div class="T_title">10. Intellectual Property</div>
    <div class="T_content">
    ...
    <div class="T_title">11. Liability</div>
    <div class="T_content">
    ...
    <div class="T_title">12.Force Majeure And Other Disclaimers</div>
    <div class="T_content">
    ...
    <div class="T_title">13.Miscellaneous</div>
    <div class="T_content">
