...
<template>
  <div class="protocol">
    ...
    how your information is collected, used and disclosed by {{ appName }} with
    ...
    1.1By using {{ appName }}, you agree that we may access, collect, use and
    share your information in accordance with this Privacy Policy, as revised
    from time to time. In addition, your use of {{ appName }} signifies that you
    agree with the terms of this Privacy Policy. If you do not agree to the
    terms of this Privacy Policy, do not use {{ appName }}. <br /><br />
    ...
    {{ appName }}. Any terms used in this Privacy Policy will have the same
    meaning as the equivalent defined terms in the {{ appName }} Terms of
    Service unless otherwise defined in this Privacy Policy or the context
    requires otherwise. Unless otherwise specified in this Privacy Policy, these
    terms in the {{ appName }} Terms of Service shall also be applicable in this
    ...
    other companies and organizations who advertise their services on
    {{ appName }}. We bear no liability for any third party use of any
    information provided by you to them. <br /><br />
    2. We obtain information about you through the means discussed below when we
    provide the {{ appName }} Services. Please note that we need certain types
    of information so that we can provide the {{ appName }} Services to you.
    <br /><br />
    ...
    age,email,password,social media account information (profile photo,Video),
    and any tags you posted about yourself; <br /><br />
    2)Any information included in your {{ appName }} profile which are visible
    to other users of {{ appName }}, or information you make available to us via
    your use of {{ appName }}, which may include your photos, gender;
    <br /><br />
    ...
    upload, distribute, or stream on the Application while using the
    {{ appName }}
    Service;
    <br /><br />
    ...
    sensitive personal information are for the purposes and in the manner as
    ...
    {{ appName }} are only applicable to users of 18 years old or more. We do
    not allow users under 18 years old to access our platform, and will not
    knowingly collect the personal information of users under 18 years old.
    <br /><br />
    ...
    {{ appName }} account Relevant content you requested, such as information
    about your location and that of your {{ appName }} contact; <br /><br />
    ...
    <br /><br />
    8)Relating to corporate transactions involving {{ appName }}, such as the
    purchase or sale of business units, acquisitions, mergers, sale of assets or
    other similar events. <br /><br />
    {{ appName }} allows you to share text messages, photos, screenshots, videos
    and other communications in the {{ appName }} application with other users,
    and if you choose to do so your text messages, photos, screenshots, videos
    and other communications will be stored on our servers. In addition, if you
    choose to share these items with other {{ appName }} users, we may not be
    able to remove them from our servers or make them unavailable to anyone you
    have shared them with. Sending and sharing text messages, photos,
    screenshots, videos or other communications in the {{ appName }} application
    is your decision. By choosing to share that information, you should
    understand that you may no longer be able to control how that information is
    used and that it may become publicly available (depending in part on your
    actions or the actions of others with whom you have shared the information).
    {{ appName }} is not responsible for any use or misuse of information you
    share. <br /><br />
    ...
    third party (or a group of companies to which {{ appName }} belongs), except
    as otherwise stated in this Privacy Policy with whom we may share your
    information: <br /><br />
    ...
    part of {{ appName }}'s group of companies (" Affiliates ").Affiliates may
    use this information to help provide, understand, and improve services
    (including by providing analytics) and their own services (including by
    providing you with a better, more relevant experience).But these affiliates
    ...
    With this feature, {{ appName }} can prevent demand frenzy.Once you share
    user content or make it public, that user content may be re-shared by
    others; <br /><br />
    ...
    information that you share in or through the {{ appName }} App with other
    users or submit in blogs, bulletin boards or chat rooms on our website or
    elsewhere may be viewed and used by others, These include sending you
    unsolicited messages or identity theft. {{ appName }} is not responsible for
    any use or misuse of your information resulting from the disclosure of your
    information <br /><br />
    ...
    personally identifiable information is limited to {{ appName }} employees,
    contractors, agents and third party service providers who want to know this
    information in order to provide, operate and develop it.Maintenance, support
    can be political into the service. <br /><br />
    ...
    our website. You agree to accept the Posting of {{ appName }} electronic
    newsletter and/or the revised Privacy Policy. And you agree that such
    electronic communications or posts constitute a notice to you of the Privacy
    Policy. We reserve the right to revise this policy from time to time, so
    please check often. If we make material changes to this Policy, we will
    notify you by Posting a revised Privacy Policy or by means of a notice on
    our website or legal requirements. You agree to periodically review the
    Privacy Policy so that you are aware of any changes. You agree that your
    continued use of the Service after we publish the revised Privacy Policy or
    provide notice on our website means that you accept the revised Privacy
    Policy. If you do not agree to the terms of the Privacy Policy, you should
    not use the Service. <br /><br />
    <div class="bt">9. Contacting Us</div>
    If you have any questions about our Privacy Policy or any privacy-related
    matters, please contact us via email at 【{{ appName }}@{{
      appName
    }}.site】. <br /><br />
  </div>
</template>
